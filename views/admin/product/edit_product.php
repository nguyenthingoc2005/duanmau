...
<div class="main">
    ...
    <main>
        ...
        <form action="<?= BASE_URL . "?mode=admin&act=edit_product"?>" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="pro_name" id="pro_name" value="<?= $product['id']?>">
            <br>
            <label for="price">Giá sản phẩm</label>
            <input type="number" id="price" name="price" value="<?= $product['price']?>">
            <br>
            <label for="img">Tên sản phẩm</label>
            ...
            <select name="status" id="">
                <option <?= $product['status'] == 1 ? "select" : "" ?> value="1">Bán</option>
                <option <?= $product['status'] == 0 ? "select" : "" ?> value="0">Chuẩn bị bán</option>
            </select>
            <br>
            ...
            <select name="cate_id" id="">
                ...
                ?>
                <option <?= $product['cate_id'] == $cate['id'] ? "select" : "" ?> value="<?= $cate['id'] ?>"><?= $cate['cat_name'] ?>"></option>
                <?php endforeach; ?>
            </select>
            <br>
